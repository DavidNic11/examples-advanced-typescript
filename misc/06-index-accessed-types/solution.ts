 ...
 */
type UserKeys = User["id" | "name" | "projects"];
type UserKeyButBetter = User[keyof User];
 ...
 */
type EntityMethods<Entity extends BaseEntity> = {
  get: (id: Entity["id"]) => void;
  update: (id: Entity["id"], updates: Partial<Entity>) => void;
